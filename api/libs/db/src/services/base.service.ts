import { DB_LOGGER_SERVICE, IdType, WithId } from '@core/common';
...
import { ActivityLogsService } from 'libs/activity-log/src/activity-logs.service';
import { ActivityLogMetadata } from 'libs/activity-log/src/activity-log-metadata';
import { ActivityLog } from 'libs/activity-log/src/activity-log.entity';
...
export class BaseService<Entity extends WithId = any> extends BaseFindService<Entity> {
  ...
  protected readonly dbLoggerService?: ActivityLogsService<Entity>;
